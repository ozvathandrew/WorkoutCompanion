	...
	<form method="POST" action="${formAction}">
			...
			<tr>
				<div class="form-group">
					...
					<td><input type="text" name="sets" placeHolder="Sets" class="form-control" /></td>
				</div>
			</tr>
			<tr>
				<div class="form-group">
					<th><label for="reps">Reps: </label></th>
					<td><input type="text" name="reps" placeHolder="Reps" class="form-control" /></td>
				</div>
			</tr>
			<tr>
				<div class="form-group">
					<th><label for="weight">Weight: </label></th>
					<td><input type="text" name="weight" placeHolder="Weight" class="form-control" /></td>
				</div>
			</tr>
			<tr>
					<th><c:out value="${machine.name}" /></th>
				<input type="hidden" name="equipment_id" value="${machine.equipment_id}" /> 
					<br>
