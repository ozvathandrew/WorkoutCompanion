...
INSERT INTO class_schedule(username, class_name, class_start_time, class_end_time, class_date) VALUES (?,?,?,?,?);

SELECT * FROM classes_schedule WHERE username = ?;

SELECT * FROM classes;

SELECT * FROM class_schedule WHERE username = ?
